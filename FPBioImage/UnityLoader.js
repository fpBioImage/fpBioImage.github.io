...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 12742811;
      var PACKAGE_UUID = 'fba89f63-8a67-48c1-81e4-410b923c3bc7';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    new DataRequest(9281622, 11157086, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(11157086, 12654458, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(12654458, 12715186, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(12715186, 12742811, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
